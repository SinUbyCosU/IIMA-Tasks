...
-  Ten FIBIS datasets saved under folders that precisely match the online titles.
-  Automated pipelines for Tasks 2 and 3 with no manual transcription; notebooks document the execution path.
-  Brief READMEs per task covering dataset choices, pagination/error tactics, parsing heuristics, and limitations.
